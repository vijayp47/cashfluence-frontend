  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        if (hasOrgKeyword) {
          toast.error(
            "Only individuals are allowed to apply. Organizations are not eligible."
          );
          setIsLoading(false);
          return;
        }
      ...
      <div className="bg-white shadow-md rounded-lg w-full max-w-md p-6 h-full min-h-screen">
        ...
        <div className="flex mb-6 relative mt-8">
          <button
            ...
            className={`font-sans relative font-normal text-[16px] flex-1 py-2 ${
              !isLogin ? "bg-[#5EB66E] text-white" : "bg-[#E5E5E5] text-black"
            }`}
          ...
          <button
            ...
            className={`relative text-[16px] flex-1 py-2 ${
              isLogin ? "bg-[#5EB66E] text-white" : "bg-[#E5E5E5] text-black"
            }`}
          >
            Login
        ...
        {!isVerifying ? (
          ...
          >
            {!isLogin && (
              <>
                <div className="mt-3">
                  <label
                    htmlFor="firstName"
                    className="block text-[16px] text-[#8F959E] font-sans text-base leading-[21.82px] text-left mb-1"
                  >
                    First Name
                  </label>
                  <input
                  ...
                  />
                  {errors.firstName && (
                    <span className="text-red-500 text-[16px] text-left">
                ...
                <div className="mt-3">
                  ...
                  />
                  {errors.lastName && (
                    <span className="text-left text-red-500 text-[16px]">
            ...
            <div className="relative mt-3">
              <label
                htmlFor="password"
                className="block text-[#8F959E] text-[16px] font-sans text-base leading-[21.82px] text-left mb-1"
              >
                Password
              </label>
              <input
            ...
            {!isLogin && (
              <div className="relative mt-3">
                <label
                  ...
                  className="text-[16px] block text-[#8F959E] font-sans text-base leading-[21.82px] text-left mb-1"
                >
                  Confirm Password
                </label>
                <input
          ...
          <form onSubmit={handleOtpSubmit} className="space-y-4 mt-6 text-left">
            <div className="mt-3">
              <div className="flex justify-between items-center mt-3 mb-2">
                <label
                  htmlFor="otp"
                  className="text-[16px] text-[#8F959E] font-sans text-base leading-[21.82px]"
                >
                  Enter OTP
                </label>
                <button
            ...
            <div className="flex flex-col justify-center items-center p-4">
              <div className="rounded-lg  mb-4 w-full max-w-md">
                ...
                <p className="text-center text-base text-[#646464] -mt-3">
                  We've just sent you a special code via email. Go grab it,
                  enter it here, and let's get you set up for success! 🚀
                </p>
              </div>
            </div>
          </form>
