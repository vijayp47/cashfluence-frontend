    ...
    <div className="flex justify-center min-h-screen bg-gray-100">
      <div className="bg-white shadow-lg rounded-lg w-full max-w-md flex flex-col">
        ...
        <div className="flex items-center border-b p-4 bg-gray-50">
          ...
          <h1 className="font-sans text-lg font-extrabold text-gray-800">Frequently Asked Questions</h1>
            ...
            {[
              {
                ...
                answer: "We offer personal loans, microloans, and business loans."
              },
              {
                question: "What are the eligibility requirements?",
                answer: "You must be at least 18 years old and have a steady income."
              },
              {
              ...
              },
              {
                ...
                answer: "Repayment terms vary by loan type, ranging from 3 to 36 months."
              },
              {
