...
//          {/* Search Bar for small ,medium and large devices */}
//          {showSearchBar && (
//           <div className="w-[80vw] md:w-auto flex-grow md:px-8 mt-4 md:mt-0 hidden sm:block">
...
//             </p>
//             <p className="font-bold text-sm sm:text-[1.05rem]">{profileData?.email}</p>
//           </div>
//           {/* Profile Image */}
//           <div
//             ref={dropdownRef}
...
//          {showSearchBar && (
//           <div className="w-[80vw] md:w-auto flex-grow md:px-8 mt-4 md:mt-0 sm:hidden ">
